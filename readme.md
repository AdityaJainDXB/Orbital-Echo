...
A custom browser new tab page with a live NASA background, real space data, and a Windows XP-style retro look. Instead of staring at a blank tab or another generic dashboard, every new tab becomes a quick mission briefing — pulling live data straight from NASA into a fast, distraction-free workspace.

Built for the [Stardance Challenge](https://stardance.hackclub.com/missions/nasa-page/guide) nasa-page mission.
